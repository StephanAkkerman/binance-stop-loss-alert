                ...
                if side == "SELL":
                    ...
                    if orderType != "MARKET":
                        if sym not in sent:
                            ...
                            msg = " ".join(
                                [orderType, "sold", sym, "$" + str(msgPrice)]
                            )
                            sendSellAlert(msg)
                            sent.append(sym)
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Margin
        margin_user = BinanceWebSocketApiManager(
            process_stream_data=userInfo, exchange="binance.com-margin"
        )
        ...
        # USD-M Futures
        usd_futures_user = BinanceWebSocketApiManager(
            process_stream_data=userInfo, exchange="binance.com-futures"
        )
        ...
        # Coin-M Futures
        coin_futures_user = BinanceWebSocketApiManager(
            process_stream_data=userInfo, exchange="binance.com-coin-futures"
        )
